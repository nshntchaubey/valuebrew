...
/// constructor (`loadAsset`, `assetKey`) stays generic and testable in
/// isolation. This is the one place that wires it to the real bundled
/// asset ([rootBundle.loadString] and [AppConstants.catalogAssetKey]).
///
/// Override this provider in tests to substitute a fake repository without
/// touching the real Flutter asset bundle.
